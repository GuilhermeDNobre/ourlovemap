...
export function LogoMark({ size = 24, variant = 'auto', className = '' }: LogoMarkProps) {
  const colorClass = {
    auto: 'text-fg-1',
    dark: 'text-[#2E0932]',
    white: 'text-white',
    ...
    >
      <style>{`
        .olm-logo-path {
          stroke-dasharray: 1;
          stroke-dashoffset: 1;
          animation: olm-logo-draw 900ms cubic-bezier(0.4, 0, 0.2, 1) forwards;
        }
        @keyframes olm-logo-draw {
