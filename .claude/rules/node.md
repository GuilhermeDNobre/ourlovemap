...
Se necessário, faça a instalação dos types das bibliotecas, por exemplo: `jest` e `@types/jest`. Fastify já inclui seus próprios tipos no pacote principal — não é necessário instalar `@types/fastify` separadamente.
...
# Fastify — tipos inclusos
npm install fastify

# Plugins oficiais já incluem tipos
